...
\begin{frame}{Series E: Prospective Predictions (No Measured Data)}
  ...
  \begin{tabular}{lcccl}
    \toprule
    \textbf{Compound ID} & \textbf{Pred.\ pIC$_{50}$} & \textbf{Pred.\ IC$_{50}$ ($\mu$M)} & \textbf{Struct.\ Class} & \textbf{Key Feature} \\
    \midrule
    ROY-0000308 & 4.883 & 13.08 & A & Fluorophenyl anchor \\
    ROY-0000307 & 4.467 & 34.11 & A & Bromopyridine (weakest) \\
    ROY-0000287 & 5.132 & 7.38  & B & Hexyloxy (best predicted) \\
    ROY-0000286 & 4.953 & 11.15 & B & Phenylpropyloxy \\
    ROY-0000275 & 4.563 & 27.33 & A & Bromopyridine (weak) \\
    ROY-0000268 & 4.767 & 17.09 & A & Alkyne-phenyl \\
    \midrule
    \multicolumn{2}{l}{\textbf{Ranges}} & \textbf{7.38 -- 34.11\,$\mu$M} & \multicolumn{2}{l}{\textbf{pIC$_{50}$: 4.47 -- 5.13}} \\
    \bottomrule
  \end{tabular}
  ...
  \begin{columns}
    ...
    \begin{alertblock}{Status}
      \small
      \begin{itemize}
        \item \textbf{Classification}: 6 prospective compounds
        \item \textbf{Measured values}: None (awaiting synthesis \& testing)
        \item \textbf{Uncertainty}: All zero (uniform ensemble predictions --- extrapolation region)
        \item \textbf{Best predicted}: ROY-0000287 at 7.38\,$\mu$M (pIC$_{50}$ 5.13)
      \end{itemize}
    \end{alertblock}
  \end{columns}
\end{frame}
