...
- [x] **pandas** - ✅ (in requirements.txt: pandas>=2.0.0)
- [x] **numpy** - ✅ (in requirements.txt: numpy>=1.24.0)
- [x] **rdkit.Chem** - ✅ (in requirements.txt: rdkit>=2024.0.0)
...
- [x] **descriptors** - Local module ✅
  ...
  - All dependencies in requirements.txt: rdkit>=2024.0.0, mordred>=1.2.0
...
To verify requirements.txt is complete, run:
