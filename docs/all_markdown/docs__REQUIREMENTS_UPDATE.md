...
### 1. **Simplified config/requirements.txt**
...
```
Commit: Simplify config/requirements.txt and add setup guide
- Reduced config/requirements.txt from 130+ to 26 essential packages
...
1. Users can now install the project with: `pip install -r config/requirements.txt`
