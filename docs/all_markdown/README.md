...
- Create the conda environment (uses `config/environment.yml`):
...
If you'd like, I can also create an `config/environment.yml` variant pinned to exact versions or add a small wrapper to run `main.py` with timing/logging.
